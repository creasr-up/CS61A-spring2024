...
def max_scoring_num_rolls(dice=six_sided, samples_count=1000):
    ...
    while(num<=10):
        ...
        average_dice1=make_averaged(roll_dice,samples_count)(num,dice)
        if(average_dice1>max_aver):
            max_aver=average_dice1
            max_index=num
        num+=1
    return max_index
    # END PROBLEM 9
...
def sus_strategy(score, opponent_score, threshold=11, num_rolls=6):
    ...
    # BEGIN PROBLEM 11
    k=score
    if(sus_update(0,score,opponent_score)-k>=threshold):return 0
    else :return num_rolls   # Remove this line once implemented.
    # END PROBLEM 11
